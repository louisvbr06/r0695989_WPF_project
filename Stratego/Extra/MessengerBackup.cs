...
namespace MoreCoffee.Extensions
{
    public class Messenger
    {
        ...
        public void Register<T>(object recipient, Action<T> action, string localKey)
        {
            Register(recipient, action, localKey, null);
        }
        ...
        public void Register<T>(object recipient, Action<T> action, string localKey, object context)
        {
            var key = new MessengerKey(recipient, context, localKey);
        ...
        /// </summary>
        /// <param name="recipient"></param>
        public void Unregister(object recipient, string localKey)
        {
            Unregister(recipient,localKey, null);
        }
        ...
        /// <param name="recipient"></param>
        /// <param name="context"></param>
        public void Unregister(object recipient, string localKey, object context)
        {
            object action;
            var key = new MessengerKey(recipient, context, localKey);
        ...
        protected class MessengerKey
        {
            ...
            /// <param name="recipient"></param>
            /// <param name="context"></param>
            public MessengerKey(object recipient, object context, string key)
            {
                Recipient = recipient;
                Context = context;
                LocalKey = key;
            ...
            {
                return Equals(Recipient, other.Recipient) && Equals(Context, other.Context) && Equals(LocalKey, other.LocalKey);
            }
            ...
            public override int GetHashCode()
            {
                unchecked
                {
                    return ((Recipient != null ? Recipient.GetHashCode() : 0) * 397) ^ (Context != null ? Context.GetHashCode() : 0) ^ (LocalKey != null ? LocalKey.GetHashCode() : 0);
                }
            }
        }
    }
